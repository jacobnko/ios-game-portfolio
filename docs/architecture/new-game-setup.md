...
### 스토어 스크린샷 — 6.5" 한 벌만 만든다 (Chordline D-108)
...
버킷은 **6.5"(1284x2778) 한 벌만** 만든다. Apple이 이걸 더 작은 디스플레이로 자동 축소해
주고, App Store Connect가 기본으로 열어주는 슬롯도 여기다. 6.9"(1320x2868)를 따로 만드는
건 업로드 슬롯을 하나 더 채울 뿐 얻는 게 없다.
